...
class FornecedoresController extends AppBaseController
{
    ...
    public function store(CreateFornecedoresRequest $request)
    {
        ...
        Flash::success('Fornecedores saved successfully.');
    ...
    {
        $fornecedores = $this->fornecedoresRepository->find($id);

        if (empty($fornecedores)) {
            Flash::error('Fornecedores not found');
    ...
    public function update($id, UpdateFornecedoresRequest $request)
    {
        ...
        Flash::success('Fornecedores updated successfully.');
    ...
    public function destroy($id)
    {
        ...
        Flash::success('Fornecedores deleted successfully.');
